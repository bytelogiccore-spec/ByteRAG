    ...
    pub fn group_by_sum(
        ...
        #[cfg(feature = "gpu")]
        {
            ...
            let mut hash_keys_dev = stream
                ...
                .map_err(|e| ByteRagError::Gpu(format!("Failed to alloc hash keys: {:?}", e)))?;
            let mut hash_sums_dev = stream
                .clone_htod(&hash_sums)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to alloc hash sums: {:?}", e)))?;
            let mut hash_counts_dev = stream
                .clone_htod(&hash_counts)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to alloc hash counts: {:?}", e)))?;
            ...
            hash_keys = stream
                ...
                .map_err(|e| ByteRagError::Gpu(format!("Failed to copy hash keys: {:?}", e)))?;
            hash_sums = stream
                .clone_dtoh(&hash_sums_dev)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to copy hash sums: {:?}", e)))?;
            hash_counts = stream
                .clone_dtoh(&hash_counts_dev)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to copy hash counts: {:?}", e)))?;
    ...
    pub fn group_by_min_max(
        ...
        #[cfg(feature = "gpu")]
        {
            ...
            let mut hash_values_dev = stream
                ...
                .map_err(|e| ByteRagError::Gpu(format!("Failed to alloc hash values: {:?}", e)))?;
            let mut hash_counts_dev = stream
                .clone_htod(&hash_counts)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to alloc hash counts: {:?}", e)))?;
            ...
            hash_values = stream
                ...
                .map_err(|e| ByteRagError::Gpu(format!("Failed to copy hash values: {:?}", e)))?;
            hash_counts = stream
                .clone_dtoh(&hash_counts_dev)
                .map_err(|e| ByteRagError::Gpu(format!("Failed to copy hash counts: {:?}", e)))?;
