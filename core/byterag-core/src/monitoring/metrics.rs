//! ByteRagMetrics — Global atomic metrics registry.
//!
...
/// Global metrics registry for ByteRAG.
///
/// Embedded in `Database` as `Arc<ByteRagMetrics>` — cloning the Arc is cheap.
pub struct ByteRagMetrics {
    // ── Operation Counters ──────────────────────────
...
impl Default for ByteRagMetrics {
    fn default() -> Self {
        Self::new()
    }
}
