...
use byterag_core::storage::compression::CompressionAlgorithm;
use byterag_core::storage::partition::{
...
#[test]
fn test_stats_auto_incremented_on_insert() -> ByteRagResult<()> {
...
#[test]
fn test_partition_creation_time_auto_recorded() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_run_lifecycle_archives_old_partition() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_run_all_lifecycles() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_run_lifecycle_no_policy_returns_error() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
