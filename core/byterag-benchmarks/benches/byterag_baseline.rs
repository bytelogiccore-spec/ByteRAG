...
fn bench_byterag_insert(c: &mut Criterion) {
    let mut group = c.benchmark_group("byterag_insert");
...
fn bench_byterag_get(c: &mut Criterion) {
    let mut group = c.benchmark_group("byterag_get");
...
fn bench_byterag_scan(c: &mut Criterion) {
    let mut group = c.benchmark_group("byterag_scan");
...
fn bench_byterag_mixed_workload(c: &mut Criterion) {
    let mut group = c.benchmark_group("byterag_mixed_workload");
