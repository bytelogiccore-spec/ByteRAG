...
impl ShardManager {
    ...
    pub fn shard_batch(&self, batch: &RecordBatch) -> ByteRagResult<Vec<DataShard>> {
    ...
    fn shard_round_robin(&self, batch: &RecordBatch) -> ByteRagResult<Vec<DataShard>> {
    ...
    fn shard_hash(&self, batch: &RecordBatch) -> ByteRagResult<Vec<DataShard>> {
        use ahash::AHasher;
    ...
    fn shard_range(&self, batch: &RecordBatch) -> ByteRagResult<Vec<DataShard>> {
