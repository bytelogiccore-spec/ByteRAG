...
cargo bench -p byterag-benchmarks --bench official_db_comparison -- byterag_
cargo bench -p byterag-benchmarks --bench official_db_comparison -- sqlite_
cargo bench -p byterag-benchmarks --bench official_db_comparison -- sled_
cargo bench -p byterag-benchmarks --bench official_db_comparison -- redb_
```
