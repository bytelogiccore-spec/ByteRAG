...
#[test]
fn test_create_and_drop_sql_index() -> byterag_core::ByteRagResult<()> {
...
#[test]
fn test_multiple_sql_indexes() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_ddl_api_integration() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_sql_index_vs_hash_index() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
