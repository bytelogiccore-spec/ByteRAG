...
| **C++** | Google Benchmark | `./build/benchmarks/byterag_ffi_benchmark` |
...
```bash
cd lang/cpp
cmake --build build --target byterag_ffi_benchmark
./build/benchmarks/byterag_ffi_benchmark
```
