...
**[→ docs.rs에서 전체 API 문서 보기](https://docs.rs/byterag-core)**
...
| 타입 | 설명 |
|------|------|
| [`Database`](https://docs.rs/byterag-core/latest/byterag_core/struct.Database.html) | 메인 데이터베이스 핸들 |
| [`Transaction`](https://docs.rs/byterag-core/latest/byterag_core/transaction/struct.Transaction.html) | MVCC 트랜잭션 |
| [`Table`](https://docs.rs/byterag-core/latest/byterag_core/derive.Table.html) | 스키마 derive 매크로 |
