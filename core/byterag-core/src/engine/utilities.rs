...
impl Database {
    ...
    /// ```
    pub fn rotate_key(&self, new_encryption: EncryptionConfig) -> ByteRagResult<usize> {
    ...
    pub fn count(&self, table: &str) -> ByteRagResult<usize> {
    ...
    pub fn table_names(&self) -> ByteRagResult<Vec<String>> {
    ...
    /// # }
    /// ```
    pub fn gc(&self) -> ByteRagResult<usize> {
    ...
    pub fn gc_estimate(&self) -> ByteRagResult<usize> {
        use crate::transaction::mvcc::gc::GarbageCollector;
