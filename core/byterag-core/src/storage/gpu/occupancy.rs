...
impl OccupancyCalculator {
    ...
    pub fn calculate_optimal_block_size(&self, params: &OccupancyParams) -> ByteRagResult<usize> {
    ...
    pub fn calculate_occupancy(&self, params: &OccupancyParams) -> ByteRagResult<f64> {
