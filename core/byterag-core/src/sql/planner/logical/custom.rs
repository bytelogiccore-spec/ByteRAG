...
impl LogicalPlanner {
    ...
    /// CREATE FUNCTION 파싱
    fn parse_create_function(&self, sql: &str) -> ByteRagResult<LogicalPlan> {
    ...
    /// CREATE TRIGGER 파싱
    fn parse_create_trigger(&self, sql: &str) -> ByteRagResult<LogicalPlan> {
    ...
    /// CREATE JOB 파싱
    fn parse_create_job(&self, sql: &str) -> ByteRagResult<LogicalPlan> {
