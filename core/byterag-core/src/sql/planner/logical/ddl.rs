...
impl LogicalPlanner {
    ...
    pub(super) fn plan_ddl(&self, statement: &Statement) -> ByteRagResult<LogicalPlan> {
        match statement {
            Statement::Drop {
                names,
                object_type,
            ...
            Statement::AlterTable {
                ...
                let operation = operations.first().ok_or_else(|| {
                    ByteRagError::Schema("ALTER TABLE requires at least one operation".to_string())
                })?;
            ...
            Statement::CreateIndex(create_index) => {
                ...
                let index_name = create_index
                    ...
                    .as_ref()
                    .ok_or_else(|| {
                        ByteRagError::Schema("CREATE INDEX requires an index name".to_string())
                    })?
                    .to_string();
