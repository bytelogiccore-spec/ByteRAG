...
impl Database {
    ...
    /// use byterag_core::automation::callable::{DataType, Signature, Value};
    ///
    ...
    /// # }
    /// ```
    pub fn call_udf(&self, name: &str, args: &[Value]) -> ByteRagResult<Value> {
    ...
    /// 등록된 UDF 목록 조회
    pub fn list_udfs(&self) -> ByteRagResult<Vec<String>> {
