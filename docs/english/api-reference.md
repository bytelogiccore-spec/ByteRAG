...
**[→ View Full API Documentation on docs.rs](https://docs.rs/byterag-core)**
...
| Type | Description |
|------|-------------|
| [`Database`](https://docs.rs/byterag-core/latest/byterag_core/struct.Database.html) | Main database handle |
| [`Transaction`](https://docs.rs/byterag-core/latest/byterag_core/transaction/struct.Transaction.html) | MVCC transaction |
| [`Table`](https://docs.rs/byterag-core/latest/byterag_core/derive.Table.html) | Derive macro for schema |
