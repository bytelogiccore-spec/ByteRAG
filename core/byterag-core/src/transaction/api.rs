...
impl Database {
    ...
    pub fn begin(&self) -> ByteRagResult<Transaction<'_, Active>> {
        Ok(Transaction {
            db: self,
            ops: Vec::new(),
...
impl<'a> Transaction<'a, Active> {
    ...
    pub fn insert(&mut self, table: &str, key: &[u8], value: &[u8]) -> ByteRagResult<()> {
    ...
    pub fn delete(&mut self, table: &str, key: &[u8]) -> ByteRagResult<bool> {
    ...
    pub fn commit(self) -> ByteRagResult<Transaction<'a, Committed>> {
    ...
    pub fn rollback(self) -> ByteRagResult<Transaction<'a, RolledBack>> {
...
impl crate::traits::DatabaseTransaction for Database {
    fn begin(&self) -> ByteRagResult<Transaction<'_, Active>> {
