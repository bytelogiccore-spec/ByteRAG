...
/// Error codes
pub const byterag_OK: c_int = 0;
pub const byterag_ERR_NULL_PTR: c_int = -1;
pub const byterag_ERR_INVALID_UTF8: c_int = -2;
pub const byterag_ERR_DATABASE: c_int = -3;
pub const byterag_ERR_NOT_FOUND: c_int = -4;
pub const byterag_ERR_INVALID_OP: c_int = -5;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_open(path: *const c_char) -> *mut DbxHandle {
    if path.is_null() {
        return ptr::null_mut();
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_open_in_memory() -> *mut DbxHandle {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_load_from_file(path: *const c_char) -> *mut DbxHandle {
    if path.is_null() {
        return ptr::null_mut();
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_insert(
    ...
    let table_str = match CStr::from_ptr(table).to_str() {
        Ok(s) => s,
        Err(_) => return byterag_ERR_INVALID_UTF8,
    };
    ...
    match handle.db.insert(table_str, key_slice, value_slice) {
        Ok(_) => byterag_OK,
        Err(_) => byterag_ERR_DATABASE,
    }
}

/// Get a value by key from a table
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_get(
    handle: *mut DbxHandle,
    table: *const c_char,
    key: *const u8,
    key_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_delete(
    handle: *mut DbxHandle,
    table: *const c_char,
    key: *const u8,
    key_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_insert_batch(
    handle: *mut DbxHandle,
    table: *const c_char,
    keys: *const *const u8,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan(
    handle: *mut DbxHandle,
    table: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_range(
    handle: *mut DbxHandle,
    table: *const c_char,
    start_key: *const u8,
    start_key_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan_result_count(result: *const DbxScanResult) -> usize {
    if result.is_null() {
        return 0;
    }
    (*result).entries.len()
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan_result_key(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan_result_value(
    result: *const DbxScanResult,
    index: usize,
...
/// Free a scan result
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan_result_free(result: *mut DbxScanResult) {
    if !result.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_scan_zero_copy(
    handle: *mut DbxHandle,
    table: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_zero_copy_result_data(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_zero_copy_result_free(result: *mut DbxZeroCopyScanResult) {
    if !result.is_null() {
        drop(Box::from_raw(result));
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_count(
    handle: *mut DbxHandle,
    table: *const c_char,
    out_count: *mut usize,
) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_flush(handle: *mut DbxHandle) -> c_int {
    if handle.is_null() {
        return byterag_ERR_NULL_PTR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_table_names(
    handle: *mut DbxHandle,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_string_list_count(list: *const DbxStringList) -> usize {
    if list.is_null() {
        return 0;
    }
    (*list).names.len()
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_string_list_get(
...
/// Free a string list
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_string_list_free(list: *mut DbxStringList) {
    if !list.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_gc(handle: *mut DbxHandle, out_deleted: *mut usize) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_is_encrypted(handle: *mut DbxHandle) -> c_int {
    if handle.is_null() {
        return 0;
    }
    let handle = &*handle;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_execute_sql(
    handle: *mut DbxHandle,
    sql: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_create_index(
    handle: *mut DbxHandle,
    table: *const c_char,
    column: *const c_char,
) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_drop_index(
    handle: *mut DbxHandle,
    table: *const c_char,
    column: *const c_char,
) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_has_index(
    handle: *mut DbxHandle,
    table: *const c_char,
    column: *const c_char,
) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_current_timestamp(handle: *mut DbxHandle) -> u64 {
    if handle.is_null() {
        return 0;
    }
    let handle = &*handle;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_allocate_commit_ts(handle: *mut DbxHandle) -> u64 {
    if handle.is_null() {
        return 0;
    }
    let handle = &*handle;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_insert_versioned(
    handle: *mut DbxHandle,
    table: *const c_char,
    key: *const u8,
    key_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_get_snapshot(
    handle: *mut DbxHandle,
    table: *const c_char,
    key: *const u8,
    key_len: usize,
    ...
    match handle.db.get_snapshot(table_str, key_slice, read_ts) {
        ...
        Ok(Some(None)) | Ok(None) => byterag_ERR_NOT_FOUND,
        Err(_) => byterag_ERR_DATABASE,
    }
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_free_value(value: *mut u8, len: usize) {
    if !value.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_close(handle: *mut DbxHandle) {
    if !handle.is_null() {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_last_error() -> *const c_char {
    c"No error".as_ptr()
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_begin_transaction(handle: *mut DbxHandle) -> *mut DbxTransaction {
    if handle.is_null() {
        return ptr::null_mut();
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_transaction_insert(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_transaction_delete(
    tx: *mut DbxTransaction,
    table: *const c_char,
    key: *const u8,
    key_len: usize,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_transaction_commit(tx: *mut DbxTransaction) -> c_int {
    if tx.is_null() {
        return byterag_ERR_NULL_PTR;
    }
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_transaction_rollback(tx: *mut DbxTransaction) {
    if !tx.is_null() {
...
/// Drop a table
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_drop_table(handle: *mut DbxHandle, table: *const c_char) -> c_int {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn byterag_list_tables(
    handle: *mut DbxHandle,
    out_list: *mut *mut DbxStringList,
) -> c_int {
    if handle.is_null() || out_list.is_null() {
