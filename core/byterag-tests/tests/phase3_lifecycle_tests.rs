...
#[test]
fn test_enable_auto_archive_and_query() -> ByteRagResult<()> {
...
#[test]
fn test_should_archive_partition() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_should_delete_partition() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_lifecycle_missing_returns_error() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_lifecycle_boundary_exact_days() -> ByteRagResult<()> {
    let db = Database::open_in_memory()?;
