...
function main() {
    ...
    // Benchmark DBX
    const ByteRagResults = benchmarkDBX();
    printResults('DBX Native (napi-rs) with Batch API', ByteRagResults);
    ...
    const insertRatio = sqliteResults.insertTime / ByteRagResults.insertTime;
    const getRatio = sqliteResults.getTime / ByteRagResults.getTime;
    const deleteRatio = sqliteResults.deleteTime / ByteRagResults.deleteTime;
