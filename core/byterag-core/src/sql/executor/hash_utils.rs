...
pub fn hash_batch(batch: &RecordBatch, columns: &[usize], seed: u64) -> ByteRagResult<UInt64Array> {
...
fn update_hashes(col: &ArrayRef, hashes: &mut [u64], hasher: &RandomState) -> ByteRagResult<()> {
