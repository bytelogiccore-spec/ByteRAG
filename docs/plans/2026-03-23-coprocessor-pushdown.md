...
**Files:**
- Modify: `core/byterag-core/src/grid/protocol.rs` — `Query`/`QueryResult` variant 추가
- Test: `core/byterag-core/src/grid/protocol.rs` (inline tests)
...
Run: `cargo test -p byterag-core grid::protocol::tests --no-default-features`
...
Run: `cargo test -p byterag-core grid::protocol::tests -v`
Expected: 3 tests PASS

**Step 5: Commit**

```bash
git add core/byterag-core/src/grid/protocol.rs
...
**Files:**
- Modify: `core/byterag-core/src/grid/router.rs` — `Query`/`QueryResult` 매칭 추가
- Test: `core/byterag-core/src/grid/router.rs` (기존 테스트 확장)
...
**Files:**
- Create: `core/byterag-core/src/grid/coprocessor.rs`
- Modify: `core/byterag-core/src/grid/mod.rs` — `pub mod coprocessor;`
- Test: `core/byterag-core/src/grid/coprocessor.rs` (inline tests)
...
**Files:**
- Create: `core/byterag-core/src/grid/predicate_eval.rs`
- Modify: `core/byterag-core/src/grid/mod.rs` — `pub mod predicate_eval;`
- Test: `core/byterag-core/src/grid/predicate_eval.rs` (inline tests)
...
**Files:**
- Create: `core/byterag-core/src/grid/coordinator.rs`
- Modify: `core/byterag-core/src/grid/mod.rs` — `pub mod coordinator;`
- Test: `core/byterag-core/src/grid/coordinator.rs` (inline tests)
...
**Files:**
- Modify: `core/byterag-core/src/storage/arrow_ipc.rs` — RecordBatch IPC 직렬화/역직렬화 추가
- Test: 기존 파일에 추가

**현재 arrow_ipc.rs 에 RecordBatch→bytes, bytes→RecordBatch 변환이 없으면 추가:**

```rust
pub fn batch_to_ipc(batch: &RecordBatch) -> ByteRagResult<Vec<u8>> {
    let mut buf = Vec::new();
...
pub fn ipc_to_batches(data: &[u8]) -> ByteRagResult<Vec<RecordBatch>> {
...
**Files:**
- Create: `core/byterag-core/tests/grid_coprocessor_test.rs`
...
**Files:**
- Create: `core/byterag-core/benches/coprocessor_benchmark.rs`
