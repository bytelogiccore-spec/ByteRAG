...
impl ScalarValue {
    ...
    pub fn from_array(array: &ArrayRef, idx: usize) -> crate::error::ByteRagResult<Self> {
        ...
        match array.data_type() {
            ...
            dt => Err(crate::error::ByteRagError::TypeMismatch {
...
impl ColumnarStore {
    ...
    pub fn append_row(&mut self, values: &[ScalarValue]) -> ByteRagResult<()> {
    ...
    pub fn to_record_batch(&self) -> ByteRagResult<RecordBatch> {
    ...
    fn build_column(&self, col_idx: usize, data_type: &DataType) -> ByteRagResult<ArrayRef> {
        match data_type {
            DataType::Int32 => {
