...
- **Crate Separation** — Refactored tests (`byterag-tests`), benchmarks (`byterag-benchmarks`), and examples (`byterag-examples`) into separate crates to keep the core library lightweight.
