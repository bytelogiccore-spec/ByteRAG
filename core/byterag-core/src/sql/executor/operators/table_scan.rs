...
pub struct TableScanOperator {
    ...
    receiver: Option<Receiver<ByteRagResult<RecordBatch>>>,
...
impl TableScanOperator {
    ...
    pub fn start_tier_scan(&mut self, wos_batches: Vec<RecordBatch>, ros_files: Vec<String>) {
        ...
        let (tx, rx): (SyncSender<ByteRagResult<RecordBatch>>, _) = sync_channel(32);
    ...
    fn apply_projection(&self, batch: RecordBatch) -> ByteRagResult<RecordBatch> {
