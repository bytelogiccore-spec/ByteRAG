...
#[test]
fn test_basic_select() -> byterag_core::ByteRagResult<()> {
...
#[test]
fn test_where_clause() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_and_or_conditions() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_order_by() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_limit_offset() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_count_aggregate() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
...
#[test]
fn test_complex_query() -> byterag_core::ByteRagResult<()> {
    let db = Database::open_in_memory()?;
