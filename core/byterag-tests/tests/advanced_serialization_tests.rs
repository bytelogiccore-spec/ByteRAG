...
use byterag_core::engine::SerializationRegistry;
use byterag_core::error::ByteRagResult;

#[test]
fn test_compression_zstd() -> ByteRagResult<()> {
...
#[test]
fn test_compression_with_checksum() -> ByteRagResult<()> {
    let registry = SerializationRegistry::new();
...
#[test]
fn test_compression_levels() -> ByteRagResult<()> {
    let registry = SerializationRegistry::new();
